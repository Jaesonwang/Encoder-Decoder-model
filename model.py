...
class PositionalEncoding(nn.Module):
    ...
    def forward(self, x):
        #x should have size(batch_size, seq_len, d_model) = (32, 10, 512)
        #pe should have size(1, seq_len, d_model) = (1, 10, 512)
...
class MultiHeadAttentionBlock(nn.Module):
    ...
    def attention(query, key, value, mask, dropout: nn.Dropout):
        ...
        if mask is not None:
           ...
           #attention_score.masked_fill_(mask == 0, -1e9) in video above from chatgpt
